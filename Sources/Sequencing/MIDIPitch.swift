...
public let acousticBassDrum = 35
public let bassDrum1 = 36
public let sideStick = 37
public let acousticSnare = 38
public let handClap = 39
public let electricSnare = 40
public let lowFloorTom = 41
public let closedHiHat = 42
public let highFloorTom = 43
public let pedalHiHat = 44
public let lowTom = 45
public let openHiHat = 46
public let lowMidTom = 47
public let hiMidTom = 48
public let crashCymbal1 = 49
public let highTom = 50
public let rideCymbal1 = 51
public let chineseCymbal = 52
public let rideBell = 53
public let tambourine = 54
public let splashCymbal = 55
public let cowbell = 56
public let crashCymbal2 = 57
public let vibraslap = 58
public let rideCymbal2 = 59
public let hiBongo = 60
public let lowBongo = 61
public let muteHiConga = 62
public let openHiConga = 63
public let lowConga = 64
public let highTimbale = 65
public let lowTimbale = 66
public let highAgogo = 67
public let lowAgogo = 68
public let cabasa = 69
public let maracas = 70
public let shortWhistle = 71
public let longWhistle = 72
public let shortGuiro = 73
public let longGuiro = 74
public let claves = 75
public let hiWoodBlock = 76
public let lowWoodBlock = 77
public let muteCuica = 78
